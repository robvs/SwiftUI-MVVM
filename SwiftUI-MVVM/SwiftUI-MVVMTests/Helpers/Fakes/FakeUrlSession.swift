...
//  SwiftUI-MVVM
//
//  Created by Rob Vander Sloot on 6/22/25.
//
...
final class FakeUrlSession: AppUrlSessionHandling {
    ...
    /// Convenience property to get around `#Predicate` limitations.
    var capturedUrlCount: Int { capturedUrls.count }
...
private extension FakeUrlSession {
    func resume<Model>(
        continuation: CheckedContinuation<Model, Error>,
